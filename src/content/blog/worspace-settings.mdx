...
If you want to know my personal settings I use in the VSCode / Cursir.sh, read this [article](/posts/vscode-configs/)

- [VScode](https://code.visualstudio.com/) - Editor text
- [Cursor](https://cursor.sh) - Editor text with AI
- [Fira Code](https://github.com/tonsky/FiraCode) - I absolutely love this monospaced font because of all the ligatures.
- [Runjs](https://runjs.app/) - Execute a javascript in real time, but it's nood necessary with node in latest versions.
- [NVM](https://github.com/coreybutler/nvm-windows/releases) - Change the Node Version.
...
- [Winpilot](https://github.com/builtbybel/Winpilot/releases)
